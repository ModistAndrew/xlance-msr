...
- See [start_script.sh](start_script.sh) for training and inference commands or our huggingface space for a simple demo. Checkpoints are also available [here](https://huggingface.co/chenxie95/xlance-msr-ckpt/tree/main).
